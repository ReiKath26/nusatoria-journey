                    ...
                    if(currentUnderstanding == 1)
                    {
                          ...
                          else
                         {
                              if(slot.missionNumber == 13)
                              {
                                   ...
                                   {
                                        new NPCDialog("Pasukan", "Sudah sekarang kalian ikut denganku, orang-orang mencurigakan", null),
               ...
               else if(currentUnderstanding == 2)
               {
                   ...
                   else
                   {
                          if(slot.missionNumber == 13)
                         {
                              ...
                              {
                                   new NPCDialog("Pasukan", "Hmmm....", null),
                                   new NPCDialog("Pasukan", "Beberapa pengertianmu itu masih belum benar, aku tidak bisa membiarkan kalian pergi tanpa membenarkan kesalahan kalian", null),
                                   new MainCharacterDialog(true, characterExpression.hurt, "Oh tidak...", null)
                               }, false, null);
   ...
   private void randomQuestion(int num, List<Question> question)
   {
    ...
    public void checkReview()
    {
        if(reviewCount == 0)
        {
            ...
            foreach(Review rev in toBeReviewed)
            {
               rev.resetReview();
            }
...
, false, null)
                        ...
                        new Story("Sesampainya di gudang perbekalan...", new List<Dialogs>
        {
            ...
            new MainCharacterDialog(true, characterExpression.happy, "(Kan tinggal aku masukan ke fitur penyimpanan canggih di smartphoneku dan aku bisa membawa barang-barang itu seakan-akan mereka microchip)", null),
            ...
            new MainCharacterDialog(true, characterExpression.neutral, "Baiklah, saatnya bekerja..", null),
                 ...
                 new Mission(new List<Goal>
                {
                    new GatherGoal("Mengambil 2 karung beras untuk perbekalan di rumah sebrang gudang", 2, new string[] {"Rice Sack", "Rice Sack (1)"}, null, false),
                    new GatherGoal("Mengambil 3 karung gula untuk perbekalan di rumah belakang gudang", 3, new string[] {"Sugar sack", "Sugar sack (1)", "Sugar sack (2)"}, null, false),
                    new GatherGoal("Mengambil 2 buah kelapa untuk perbekalan di pepohonan dekat gudang", 2, new string[] {"Coconut nut", "Coconut nut (1)"}, null, false)
                }), 
                 new Mission(new List<Goal>
                {
...

        {
            ...
            new MainCharacterDialog(true, characterExpression.think, "(Wow cepat sekali, sayang sekali aku melewatkan perang yang ada)", null),
...

        {
            ...
            new NPCDialog("Pejuang Jawa (?)", "Tenang, kamu cukup menjawab beberapa pertanyaan dariku saja...", null),
             new MainCharacterDialog(true, characterExpression.hurt, "Baiklah...? Anda bahkan tidak menjawab pertanyaan saya...", new string[]{"Tumenggung Baurekhsa Shoot"}),
              new MainCharacterDialog(true, characterExpression.think, "(Tunggu, orang yang berbicara diawal tadi bilang kalau yang memegang kunci akan memberikanku tantangan akhir berupa kuis kan...)", null),
 ...
 //=================================//
                        ...
                        new Story("Sultan Agung mendengarkanmu dengan seksama meskipun kamu kadang tampak ragu dalam menjawab...", new List<Dialogs>
        {
             ...
             new NPCDialog("Sultan Agung", "Tidak juga, kami sudah menaruh kekalahan itu di belakang kami...", null),
...
//=================================//
                  ...
                  new Mission(new List<Goal>
                {
                    new JudgementGoal("Menjawab beberapa pertanyaan dari Kepala Pedagang", 10, "Kepala Pedagang NPC", true)
                }), 
                  ...
                  new Mission(new List<Goal>
                {
                    ...
                    new JudgementGoal("Menjawab beberapa pertanyaan dari Kepala Pedagang", 5, "Kepala Pedagang NPC", false)
                }), 
        ...
        new NPCDialog("Pedagang", "Sedikit rekap dari kisah serangan Sultan Agung", null),
                    ...
                    new ReviewGoal("Mereview kembali beberapa kejadian bersama pedagang", 1, "Pedagang Anak NPC", new Story[]{
                     ...
                     new JudgementGoal("Menjawab beberapa pertanyaan dari dari Kepala Pedagang", 5, "Kepala Pedagang NPC", false)
                }), 
        ...
        new NPCDialog("Kepala Pedagang", " Iya, aku menemukan kunci ini ketika membersihkan kapal...entah bisa dihargai berapa ini...", null),
...
//=================================//
        ...
        {
          new NPCDialog("Kaum Adat 2", "Ho, kamu tertarik menonton sabung ayam, anak kecil?", null),
          new MainCharacterDialog(true, characterExpression.hurt, "(Kasihan ayam-ayam itu, tapi sepertinya ini memang adat mereka..)", null),
          new NPCDialog("Kaum Adat 1", "Ayam-mu sepertinya sudah kewalahan tuh.. Aku yang akan menang.. Hahaha!", null),
          new NPCDialog("Kaum Adat 2", "Tidaaak! Ayamku!!", null),
          new NPCDialog("Kaum Adat 1", "Ayo, berikan duitnya sesuai adat kita sebagai sesama Kaum Adat.", null),
        ...
        {
          new NPCDialog("Kaum Padri", "Dasar kaum Adat itu!", null),
          new MainCharacterDialog(true, characterExpression.think, "Kaum Adat?", null),
          new NPCDialog("Kaum Padri", "Ya, mereka yang berjudi dengan sabung ayam itu.", null),
          new MainCharacterDialog(true, characterExpression.hurt, "Oh, yang barusan kulihat itu.", null),
          new NPCDialog("Kaum Padri", "Padahal hal tersebut dilarang dalam ajaran Islam.", null),
          new NPCDialog("Kaum Padri", "Aku kaum Padri, bersumpah tidak akan melakukan hal-hal seperti yang mereka lakukan!", null),
          new MainCharacterDialog(true, characterExpression.think, "Memangnya mereka melakukan apa saja?", null),
          new NPCDialog("Kaum Padri", "Judi, sabung ayam, dan minum-minuman keras...", null),
          new NPCDialog("Kaum Padri", "Intinya, jangan dekat-dekat dengan mereka.", null),
          new NPCDialog("Kaum Padri", "Mereka hanya akan membawa pengaruh buruk.", null),
          new NPCDialog("Kaum Padri", "Jangan tumbuh menjadi orang seperti mereka, mengerti?", null),
          ...
          new MainCharacterDialog(true, characterExpression.think, "(Kelihatannya warga ini sangat menentang apa yang kaum Adat lakukan)", null),
               ...
               // Ubah dulu
                ...
                new Mission(new List<Goal>
                {
                        ...
                        new ExplorationGoal("Mendapatkan Dokumen Perjanjian Masang di rumah sekitar", 1, new string[] {"Perjanjian Masang"}, new int[] {-1}, new Story[] {
                ...
                new Mission(new List<Goal>
                {
                        ...
                        new Story("Kamu kembali pada Yudha yang masih di sekitar Lintau", new List<Dialogs>
                        {
                            ...
                            new MainCharacterDialog(false, characterExpression.angry, "Hei, jaga mulut kamu ya, aturan itu kami buat untuk mencegah terjadi bencana yang merusak dimensi ruang dan waktu", null),
                ...
                new Mission(new List<Goal>
                {
                    new JudgementGoal("Menjawab beberapa pertanyaan dari Pasukan Kaum Padri", 15, "Pasukan Kaum Padri", true)
                }),
                  ...
                  new Mission(new List<Goal>
                {
                    new ReviewGoal("Mereview kembali beberapa kejadian bersama Pasukan Kaum Padri", 1, "Pasukan Kaum Padri", new Story[]{
                        ...
                        {
                               new NPCDialog("Pasukan", "Aku sudah coba jelaskan secara singkat...", null),
                               new NPCDialog("Pasukan", "Seharusnya sekarang kamu bisa menjawab sedikit pertanyaan dariku", null),
                              new MainCharacterDialog(true, characterExpression.hurt, "Astaga...", null)
                        }, false, null)
                    }),
                    new JudgementGoal("Menjawab beberapa pertanyaan dari Pasukan Kaum Padri", 5, "Pasukan Kaum Padri", false)
                }),
        ...
        {
        new NPCDialog("Pasukan", "Baiklah...aku rasa karena kamu sudah membuktikan dirimu dan paham betul situasi disini...", new string[]{"Yudha (4)"}),
        new NPCDialog("Pasukan", "Aku akan membantu mengantarmu sampai keluar dari wilayah perang", null),
        new NPCDialog("Pasukan", "Oh iya, mungkin kalian tau apa yang bisa dilakukan dengan benda ini...", null),
        new MainCharacterDialog(true, characterExpression.happy, "Kunci?", null),
        ...
        new Mission(new List<Goal>
                {
                        ...
                        new Story("Kamu mengikuti pasukan Belanda tersebut dan terlihat seorang Kaum Padri dengannya...", new List<Dialogs>
                        {
                            ...
                            new MainCharacterDialog(true, characterExpression.neutral, "(Sebaiknya aku kembali mencari kak Yudha sekarang, mungkin dia ada di sektaran benteng itu...)", new string[]{"Yudha Bonjol"}),
                                new MainCharacterDialog(true, characterExpression.neutral, "(Tapi sebaiknya aku mencari semacam jalan memutar kalau aku harus masuk ke Benteng)", null),
                        }, false, null)
                    }, true)
                }),
        ...
        new Mission(new List<Goal>
                {
                        ...
                        new ExplorationGoal("Pergi ke Benteng Bonjol melalui jalan memutar", 1, new string[] {"Yudha Bonjol"}, new int[] {2}, new Story[] {
        ...
        new Mission(new List<Goal>
                {
                        ...
                        new ExplorationGoal("Pergi meninggalkan Benteng Bonjol", 1, new string[] {"Tuanku Imam Bonjol (1)"}, new int[] {-1}, new Story[] {
 ...
 new MainCharacterDialog(true, characterExpression.neutral, "Ayo kita bergegas kesana", null),
        ...
        new NPCDialog("Pasukan", "Mereka mengaku sebagai orang yang pernah membantu Pasukan Tuanku Lintau, tapi ketika aku berikan pertanyaan gagal menjawabnya, pak!", null),
        ...
        new MainCharacterDialog(false, characterExpression.think, "Baiklah, saatnya kita mengulang pelajaran, dek Player..", null),
                    ...
                    new ReviewGoal("Mereview kembali beberapa kejadian bersama Yudha", 1, "Yudha (4)", new Story[]{
                        new Story("Yudha selesai memberikan review singkat...", new List<Dialogs>{
                               new NPCDialog("Kepala Bagian", "Apa kamu sudah lebih paham?", null),
                               new NPCDialog("Kepala Bagian", "Kalau kamu sudah siap nantinya, temui saja bawahan saya kembali", null),
                ...
                new Mission(new List<Goal>
                {
                    new ExplorationGoal("Berbicara dengan Pasukan Kaum Padri", 1, new string[] {"Pasukan Kaum Padri"}, new int[] {-1}, new Story[]{
                        new Story("Setelah perjuangan cukup panjang menjawab semua pertanyaan Pasukan Kaum Padri, sepertinya kamu sudah mulai mendapat kepercayaannya", new List<Dialogs>
                {
                    new NPCDialog("Pasukan", "Baiklah...aku rasa sudah cukup", new string[]{"Yudha (4)"}),
                    new NPCDialog("Pasukan", "Kalian bisa pergi dari sini", null),
        ...
        new Mission(new List<Goal>
                {
                        ...
                        new ExplorationGoal("Pergi ke meninggalkan Benteng Bonjol", 1, new string[] {"Tuanku Imam Bonjol (1)"}, new int[] {-1}, new Story[] {
                        new Story("Langkah kalian terhenti ketika melihat Tuanku Imam Bonjol bersama dengan orang Belanda yang kamu lihat tadi", new List<Dialogs>
                        {
                            new NPCDialog("Francis", "Bagaimana kalau kita berdamai saja?", null),
                            new NPCDialog("Francis", "Toh benteng dekat perbukitan milikmu sudah jatuh ke tangan kami", null),
